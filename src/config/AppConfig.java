...
public class AppConfig {
    ...
    public static final int[] PRIMARY_BG = { 30, 30, 60};
    public static final int[] SECONDARY_BG = { 50, 50, 80};
    public static final int[] BUTTON_COLOR = { 70, 130, 180};
    public static final int[] BUTTON_HOVER = { 100, 160, 210};
    public static final int[] TEXT_COLOR = { 200, 200, 255};
    public static final int[] WHITE_TEXT = Color.WHITE;
    public static final int[] ACCENT_COLOR = { 120, 160, 210 };
    public static final int[] SUCCESS_COLOR = { 70, 180, 70 };
    public static final int[] ERROR_COLOR = { 180, 70, 70 };
